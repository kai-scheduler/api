...
import (
	"github.com/kai-scheduler/api/api/kai/v1/admission"
	"github.com/kai-scheduler/api/api/kai/v1/binder"
	"github.com/kai-scheduler/api/api/kai/v1/common"
	"github.com/kai-scheduler/api/api/kai/v1/node_scale_adjuster"
	"github.com/kai-scheduler/api/api/kai/v1/pod_group_controller"
	"github.com/kai-scheduler/api/api/kai/v1/pod_grouper"
	"github.com/kai-scheduler/api/api/kai/v1/prometheus"
	"github.com/kai-scheduler/api/api/kai/v1/queue_controller"
	"github.com/kai-scheduler/api/api/kai/v1/scheduler"
